const productCards = [
  {
    cardImage: "moisturizing-mousse",
    cardCategory: "для нормальной кожи",
    cardName: "Увлажняющий мусс",
    cardDescription:
      "Глубоко увлажняет кожу лица, оставляя её мягкой и гладкой.",
    compoundList: [
  ...
  {
    cardImage: "cleansing-gel",
    cardCategory: "для нормальной кожи",
    cardName: "Гель для умывания",
    cardDescription: "Интенсивно очищает, не повреждает защитный барьер кожи.",
    compoundList: [
      "минералы",
      "витамины С, А, РР, В И Е",
      "солнцезащитные компоненты",
  ...
  },
  {
    ...
    cardDescription: "Набор, состоящий из увлажняющего крема и маски.",
    compoundList: ["воски", "минералы", "масла"],
    price: 2750,
  },
  {
